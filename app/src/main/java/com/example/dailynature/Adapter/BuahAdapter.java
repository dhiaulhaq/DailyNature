...
import com.example.dailynature.Activity.DetailBuahActivity;
...
public class BuahAdapter extends RecyclerView.Adapter<BuahAdapter.MyViewHolder> {
    ...
    private List<Buah> mData;


    public BuahAdapter(Context mContext, List<Buah> mData) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(mContext, DetailBuahActivity.class);
